...
//    }
//
//        public static void pdfGeneratorJsonPath(String header, List <Customer> list, String fileName){
//            Document document = new Document();
//            String pdf_path = fileName;
//            String pdf_title = header;
//            //String logo_path = "C:\\Users\\fatih\\Desktop\\unnamed.jpg";
...
//                table.setHeaderRows(list.size());
//                for(int i=0;i<list.size();i++ ) {
//                    table.addCell(String.valueOf((list.get(i).getCountry().getId())));
//                    table.addCell(list.get(i).getCountry().getName());
//                    table.addCell(list.get(i).getCountry().getStates());
//
//                }
//                document.add(table);
//               // document.add(Image.getInstance(logo_path));
